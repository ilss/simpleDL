...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-2a8bb4aa","hasScoped":false,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./node_modules/vue-ueditor-wrap/lib/index.vue
...
/* harmony default export */ var forumDetails = ({
  ...
  methods: {
    ...
    deleteItem: function deleteItem(id) {
      ...
      this.$axios.post('/forum-delete-reply', { forum_id: this.$route.query.forumId, reply_id: id }).then(function (data) {
    ...
    getReply: function getReply() {
      ...
      this.$axios.get('/forum-detail/replay', { params: { forum_id: this.$route.query.forumId } }).then(function (data) {
        _this2.reply_list = [].concat(toConsumableArray_default()(data.data.data.reply_list));
      });
    },
    ...
    changeReplyPop: function changeReplyPop() {
      ...
      this.$axios.post('/forum-reply', this.forumMsg).then(function (data) {
        _this3.$message({ type: 'success', message: '回复成功' });
        _this3.getReply();
  ...
  created: function created() {
    ...
    this.forumMsg.forum_id = this.$route.query.forumId;
    this.$axios.get('/forum-detail/forum', { params: { forum_id: this.$route.query.forumId } }).then(function (data) {
      _this4.forum = extends_default()({}, data.data.data);
    });
    this.getReply();
  }
});
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-6540182c","hasScoped":false,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/views/researchForum/forumDetails.vue
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"views-research-forum-details"},[_c('p',{staticClass:"forum-title"},[_vm._v("\n        "+_vm._s(_vm.forum.forum_title)+"\n        "),_c('el-button',{staticClass:"btn dark small",on:{"click":_vm.showReplyPop}},[_vm._v(_vm._s(_vm.$t("views.researchForum.reply")))])],1),_vm._v(" "),_c('div',{staticClass:"content"},[_c('div',{staticClass:"title"},[_c('div',[_c('span',[_vm._v(_vm._s(_vm.$t("views.researchForum.author"))+"："+_vm._s(_vm.forum.poster))]),_vm._v("\n                |\n                "),_c('span',[_vm._v(_vm._s(_vm.$t("views.researchForum.issuingTime"))+"："+_vm._s(_vm.forum.poster_time))])]),_vm._v(" "),_c('div',[_c('span',[_vm._v(_vm._s(_vm.$t("views.researchForum.click"))+"："+_vm._s(_vm.forum.read_num))]),_vm._v("\n                |\n                "),_c('span',[_vm._v(_vm._s(_vm.$t("views.researchForum.reply"))+"："+_vm._s(_vm.forum.reply_num))])])]),_vm._v(" "),_c('div',{staticClass:"msg",domProps:{"innerHTML":_vm._s(_vm.forum.forum_content)}})]),_vm._v(" "),_c('ul',{staticClass:"reply"},_vm._l((_vm.reply_list),function(item,index){return _c('li',{key:index},[_c('p',{staticClass:"name"},[_vm._v(_vm._s(_vm.$t("views.researchForum.replies"))+"："+_vm._s(item.replyer))]),_vm._v(" "),_c('p',{domProps:{"innerHTML":_vm._s(item.reply_content)}}),_vm._v(" "),_c('p',{staticClass:"time"},[_vm._v("\n                "+_vm._s(_vm.$t("views.researchForum.postingTime"))+"："+_vm._s(item.reply_time)+"\n                "),(_vm.userCharacter==='admin' || item.is_delete===true)?_c('button',{on:{"click":function($event){_vm.deleteItem(item.reply_id)}}},[_c('i',{staticClass:"icon iconfont icon-shanchu2"}),_vm._v(_vm._s(_vm.$t("views.researchForum.delete")))]):_vm._e()])])})),_vm._v(" "),_c('el-dialog',{staticClass:"replyPop big",attrs:{"title":_vm.$t("views.researchForum.postReply"),"visible":_vm.replyPop},on:{"update:visible":function($event){_vm.replyPop=$event}}},[_c('div',{staticClass:"content"},[_c('vue-ueditor-wrap',{ref:"ueditor",attrs:{"destroy":false,"config":_vm.config,"init":_vm.myInit},on:{"ready":_vm.ready},model:{value:(_vm.forumMsg.content),callback:function ($$v) {_vm.$set(_vm.forumMsg, "content", $$v)},expression:"forumMsg.content"}})],1),_vm._v(" "),_c('span',{staticClass:"dialog-footer",attrs:{"slot":"footer"},slot:"footer"},[_c('el-button',{staticClass:"cancel",on:{"click":function($event){_vm.replyPop = false}}},[_vm._v(_vm._s(_vm.$t("views.researchForum.cancel")))]),_vm._v(" "),_c('el-button',{staticClass:"primary",attrs:{"type":"primary"},on:{"click":_vm.changeReplyPop}},[_vm._v(_vm._s(_vm.$t("views.researchForum.release")))])],1)])],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
