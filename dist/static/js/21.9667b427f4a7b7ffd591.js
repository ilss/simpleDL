...
/* harmony default export */ var systemAlarm = ({
  ...
  created: function created() {
    ...
    // 获取搜索的数据
    this.$axios.get('/systemManagement/systemAlarm/sel').then(function (data) {
