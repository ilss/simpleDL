...
// load the styles
var content = __webpack_require__("QZv+");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("01bc9477", content, true, {});
...
/* harmony default export */ var projectManagement = ({
  ...
  methods: {
    ...
    deleteStorage: function deleteStorage(id) {
      ...
      this.$axios.post('/init-pwd-user', { storage_id: id }).then(function (data) {
...
/* scopeId */
var __vue_scopeId__ = "data-v-06597024"
