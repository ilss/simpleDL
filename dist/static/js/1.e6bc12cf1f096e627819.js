...
/* harmony default export */ var forumSend = ({
  ...
  methods: {
    ...
    clearMsg: function clearMsg() {
      this.forumMsg.forum_title = '';
      this.forumMsg.content = '';
      this.forumMsg.forum_type = 1;
    },
    sendMsg: function sendMsg() {
      var _this = this;

      this.$axios.post('/publish-forum', this.forumMsg).then(function (data) {
        _this.$message({ type: 'success', message: '发帖成功' });
        _this.clearMsg();
      });
    }
  },
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-15db7784","hasScoped":false,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/views/researchForum/forumSend.vue
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"views-research-forum-send"},[_c('div',{staticClass:"title"},[_c('div',[_vm._v("\n      "+_vm._s(_vm.$t("views.researchForum.theme"))+"\n      "),_c('el-input',{attrs:{"placeholder":_vm.$t("views.researchForum.enter"),"clearable":""},model:{value:(_vm.forumMsg.forum_title),callback:function ($$v) {_vm.$set(_vm.forumMsg, "forum_title", $$v)},expression:"forumMsg.forum_title"}})],1),_vm._v(" "),_c('div',[_vm._v("\n      "+_vm._s(_vm.$t("views.researchForum.postType"))+"\n      "),_c('el-radio',{attrs:{"label":1},model:{value:(_vm.forumMsg.forum_type),callback:function ($$v) {_vm.$set(_vm.forumMsg, "forum_type", $$v)},expression:"forumMsg.forum_type"}},[_vm._v(_vm._s(_vm.$t("views.researchForum.help")))]),_vm._v(" "),_c('el-radio',{attrs:{"label":2},model:{value:(_vm.forumMsg.forum_type),callback:function ($$v) {_vm.$set(_vm.forumMsg, "forum_type", $$v)},expression:"forumMsg.forum_type"}},[_vm._v(_vm._s(_vm.$t("views.researchForum.share")))]),_vm._v(" "),(_vm.userCharacter==='admin')?_c('el-radio',{attrs:{"label":3},model:{value:(_vm.forumMsg.forum_type),callback:function ($$v) {_vm.$set(_vm.forumMsg, "forum_type", $$v)},expression:"forumMsg.forum_type"}},[_vm._v(_vm._s(_vm.$t("views.researchForum.notice")))]):_vm._e(),_vm._v(" "),(_vm.userCharacter==='admin')?_c('el-radio',{attrs:{"label":4},model:{value:(_vm.forumMsg.forum_type),callback:function ($$v) {_vm.$set(_vm.forumMsg, "forum_type", $$v)},expression:"forumMsg.forum_type"}},[_vm._v(_vm._s(_vm.$t("views.researchForum.announcement")))]):_vm._e()],1)]),_vm._v(" "),_c('vue-ueditor-wrap',{ref:"ueditor",attrs:{"destroy":false,"config":_vm.config,"init":_vm.myInit},on:{"ready":_vm.ready},model:{value:(_vm.forumMsg.content),callback:function ($$v) {_vm.$set(_vm.forumMsg, "content", $$v)},expression:"forumMsg.content"}}),_vm._v(" "),_c('div',{staticClass:"controls"},[_c('el-button',{staticClass:"btn dark",on:{"click":_vm.clearMsg}},[_vm._v(_vm._s(_vm.$t("views.researchForum.empty")))]),_vm._v(" "),_c('el-button',{staticClass:"btn dark",on:{"click":_vm.sendMsg}},[_vm._v(_vm._s(_vm.$t("views.researchForum.publish")))])],1)],1)}
var staticRenderFns = []
var esExports = { render: render, staticRenderFns: staticRenderFns }
