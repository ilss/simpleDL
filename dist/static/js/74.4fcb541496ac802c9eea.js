...
/* harmony default export */ var namespaces = ({
  ...
  created: function created() {
    ...
    this.$axios.get('/clusterMonitoring/namespaces/sel').then(function (data) {
